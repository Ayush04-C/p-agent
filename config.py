...
CHECK_INTERVAL_MINUTES = _env_int("CHECK_INTERVAL_MINUTES", 1, minimum=1)
CHECK_INTERVAL_SECONDS = _env_int(
    "CHECK_INTERVAL_SECONDS",
    CHECK_INTERVAL_MINUTES * 60,
    minimum=10,
)
RUN_LOOP_SLEEP_SECONDS = _env_int("RUN_LOOP_SLEEP_SECONDS", 1, minimum=1)
API_TIMEOUT_SECONDS = _env_int("API_TIMEOUT_SECONDS", 20, minimum=5)
DETAIL_FETCH_TIMEOUT_SECONDS = _env_int("DETAIL_FETCH_TIMEOUT_SECONDS", 6, minimum=2)
